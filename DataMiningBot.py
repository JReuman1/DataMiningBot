...
places = ['boston', 'chicago', 'New York', 'Los Angeles', 'Chicago', 'San Francisco', 'Toronto', 'Paris', 'London', 'Amsterdam', 'Dublin', 'Sydney', 'Melbourne', 'Tokyo', 'Osaka', 'Seoul', 'Berlin', 'Hamburg', 'Vienna', 'Zurich', 'Stockholm', 'Copenhagen', 'Toronto', 'Paris', 'London', 'Amsterdam', 'Dublin', 'Sydney', 'Melbourne', 'Tokyo', 'Osaka', 'Seoul', 'Berlin', 'Hamburg', 'Vienna', 'Zurich', 'Stockholm', 'Copenhagen']
...
for place in places:
    ...
    driver = webdriver.Firefox(executable_path= r'') #Ruta del GeckoDriver.
    ...
    for tag in hashtags:
        ...
        query = place + ' '  + tag + ' \"Other obligatory tags\" site:YOUR_SITE.com'
        search.clear()
        ...
        # Expresión regular para buscar en los span (si es para emails usar = r'[a-zA-Z0-9_.+-]+@gmail\.com')
        regex = 'SOME TEXT YOU WANT TO SCRAP'
